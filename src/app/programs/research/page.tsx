      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {researchAreas.map((area, index) => (
              <div key={index} className="border border-gray-200 rounded-lg p-6 hover:border-purple-600 transition-colors">
            ...
            {publications.map((publication, index) => (
              <div key={index} className="border border-gray-200 rounded-lg p-6 hover:border-purple-600 transition-colors">
                ...
                <div className="flex justify-end">
                  <a 
                    href="#" 
                    className="text-purple-600 hover:text-purple-800 font-bold flex items-center"
                  >
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center p-5 border-b-4 border-purple-600 rounded-lg bg-gray-50">
              <FaFileAlt className="text-purple-600 text-3xl mx-auto mb-4" />
            ...
            <div className="text-center p-5 border-b-4 border-purple-600 rounded-lg bg-gray-50">
              <FaClipboardCheck className="text-purple-600 text-3xl mx-auto mb-4" />
              <h3 className="text-xl font-bold text-gray-900 mb-2">
            ...
            <div className="text-center p-5 border-b-4 border-purple-600 rounded-lg bg-gray-50">
              <FaUsers className="text-purple-600 text-3xl mx-auto mb-4" />
              <h3 className="text-xl font-bold text-gray-900 mb-2">
