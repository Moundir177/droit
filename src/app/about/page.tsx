...
export default function AboutPage() {
  ...
  return (
    <div>
      {/* Page Header */}
      <PageHeader 
        title={language === 'fr' ? 'À propos de la Fondation' : 'حول المؤسسة'}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="relative h-96 rounded-lg overflow-hidden mb-12">
              <img 
                src="/images/justice-gavel.jpg" 
                alt={language === 'fr' ? "Justice et droits" : "العدالة والحقوق"} 
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto relative">
            ...
            <div className="relative z-10 mb-24">
              ...
              <div className="relative flex items-center justify-center mb-4">
                <div className="absolute w-full h-px bg-purple-500"></div>
                <div className="bg-purple-500 text-white font-semibold py-2 px-6 rounded-full z-10">
              ...
              <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div className="p-6 text-center">
                  ...
                  <div className="flex justify-center space-x-4">
                    ...
                    <a href="#" className="w-10 h-10 rounded-full bg-purple-500 flex items-center justify-center text-white hover:bg-purple-600 transition-colors">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
