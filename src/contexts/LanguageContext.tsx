...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'collaborations-ong': 'Collaborations ONG',
    'gallery': 'Galerie',
    'contact': 'Contact',
  ...
  ar: {
    ...
    'collaborations-ong': 'تعاون مع المنظمات',
    'gallery': 'معرض الصور',
    'contact': 'اتصل بنا',
    ...
    // About page
    'about.title': 'من نحن',
    'about.subtitle': 'مؤسسة تعزيز الحقوق في الجزائر مكرسة لتعزيز الحقوق المتساوية وبناء قدرات الفاعلين في المجتمع المدني.',
